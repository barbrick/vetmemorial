$(document).ready(function () {
    ...
    var methods =
    {
        ...
        dropDownClick: function (e) {
            e.preventDefault();
            var dropdown = $(this).parents('.gallDropdown');
            var selected = dropdown.find('.gallDropmenu .selected');
    ...
    $('.gallDropdown').on('mouseover', methods.dropDownMenu).on('mouseleave', methods.dropDownMenu);
    $('.gallDropdown .gallDropmenu-active a').on('click', methods.dropDownClick);
});
